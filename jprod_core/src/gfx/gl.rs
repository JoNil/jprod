...
pub unsafe fn GetObjectLabel(
    ...
    mem::transmute::<_, extern "system" fn(GLenum, GLuint, GLsizei, *mut GLsizei, *mut GLchar) -> ()>(
...
pub unsafe fn MapNamedBufferRange(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLintptr, GLsizeiptr, GLbitfield) -> *mut c_void>(
...
pub unsafe fn Enable(cap: GLenum) {
    mem::transmute::<_, extern "system" fn(GLenum) -> ()>(*GL_API.get_unchecked(EnableIdx as usize))(
        cap,
    )
}
...
pub unsafe fn ShaderSource(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLsizei, *const *const GLchar, *const GLint) -> ()>(
        *GL_API.get_unchecked(ShaderSourceIdx as usize),
...
pub unsafe fn GetObjectPtrLabel(
    ...
    mem::transmute::<_, extern "system" fn(*const c_void, GLsizei, *mut GLsizei, *mut GLchar) -> ()>(
        *GL_API.get_unchecked(GetObjectPtrLabelIdx as usize),
...
pub unsafe fn ProgramUniformMatrix2dv(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLint, GLsizei, GLboolean, *const GLdouble) -> ()>(
...
pub unsafe fn ProgramUniformMatrix3fv(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLint, GLsizei, GLboolean, *const GLfloat) -> ()>(
...
pub unsafe fn MapBufferRange(
    ...
    mem::transmute::<_, extern "system" fn(GLenum, GLintptr, GLsizeiptr, GLbitfield) -> *mut c_void>(
        *GL_API.get_unchecked(MapBufferRangeIdx as usize),
...
pub unsafe fn GetActiveUniformsiv(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLsizei, *const GLuint, GLenum, *mut GLint) -> ()>(
...
pub unsafe fn ProgramUniform4f(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLint, GLfloat, GLfloat, GLfloat, GLfloat) -> ()>(
...
pub unsafe fn GetUniformIndices(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLsizei, *const *const GLchar, *mut GLuint) -> ()>(
...
pub unsafe fn CopyTexImage1D(
    ...
    mem::transmute::<_, extern "system" fn(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLint) -> ()>(
...
pub unsafe fn ReadPixels(
    ...
    >(*GL_API.get_unchecked(ReadPixelsIdx as usize))(x, y, width, height, format, type_, pixels)
}
#[inline]
...
pub unsafe fn GetnTexImage(
    ...
    mem::transmute::<_, extern "system" fn(GLenum, GLint, GLenum, GLenum, GLsizei, *mut c_void) -> ()>(
...
pub unsafe fn VertexArrayAttribFormat(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLuint, GLint, GLenum, GLboolean, GLuint) -> ()>(
...
pub unsafe fn TexStorage3D(
    ...
    mem::transmute::<_, extern "system" fn(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei) -> ()>(
...
pub unsafe fn GetSynciv(
    ...
    mem::transmute::<_, extern "system" fn(GLsync, GLenum, GLsizei, *mut GLsizei, *mut GLint) -> ()>(
        *GL_API.get_unchecked(GetSyncivIdx as usize),
...
pub unsafe fn GetActiveUniformBlockName(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLuint, GLsizei, *mut GLsizei, *mut GLchar) -> ()>(
...
pub unsafe fn GetTextureImage(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLint, GLenum, GLenum, GLsizei, *mut c_void) -> ()>(
...
pub unsafe fn TextureStorage3D(
    ...
    mem::transmute::<_, extern "system" fn(GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLsizei) -> ()>(
...
pub unsafe fn ColorMaski(index: GLuint, r: GLboolean, g: GLboolean, b: GLboolean, a: GLboolean) {
    mem::transmute::<_, extern "system" fn(GLuint, GLboolean, GLboolean, GLboolean, GLboolean) -> ()>(
        *GL_API.get_unchecked(ColorMaskiIdx as usize),
    )(index, r, g, b, a)
}
#[inline]
...
pub unsafe fn ProgramUniform4d(
    ...
    >(*GL_API.get_unchecked(ProgramUniform4dIdx as usize))(program, location, v0, v1, v2, v3)
}
#[inline]
